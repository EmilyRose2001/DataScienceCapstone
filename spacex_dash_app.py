...
def get_pie_chart(entered_site):
    if entered_site == 'ALL Sites':
        ...
        title='Successful Launches at different Launch Sites')
        return fig
    else:
...
def get_scatter_chart(entered_site, payload_range):
    ...
    if entered_site == 'ALL Sites':
        fig = px.scatter(filtered_df,
                         ...
                         title='Relationship between Payload Mass and Launch Outcome for all sites')
        return fig
    else:
        ...
        fig = px.scatter(filtered_df,
                         ...
                         y='class',
                         color='Booster Version Category',
                         title = f'Relationship between Payload Mass and Launch Outcome for {entered_site}')
        return fig
